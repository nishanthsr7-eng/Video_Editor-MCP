-- Imports markers from CSV files into media pool clips. CSV must have the same name as the video and be in the same directory.
-- Set column order in the USER CONFIG AREA below.
